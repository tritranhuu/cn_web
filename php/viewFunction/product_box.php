                                ...
                                <div class="product_content">   
                                    ...
                                    <div class="product_buttons">   
                                        <div class="text-right d-flex flex-row align-items-start justify-content-start">    
                                            ...
                                            <div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center addCartSmall" proID="<?php echo $proID?>">  
                                                <div>   
...
?>  
    ...
    <div class="col-md-3 col-sm-6 col-xs-6 "> 
                            <div class="product ">  
                                <div class="product_image"><<?php echo 'a href="../controller/product_controller.php?action=index&page=1&product='.$proID.'"'; ?>><img src=<?php echo "../".$url;?> alt="" style='border: 1px solid gray; min-width: 100%; min-height: 100%;'></a></div>  
                                <div class="product_content">   
                                    <div class="product_info d-flex flex-row align-items-start justify-content-start">  
                                        <div>   
                                            <div>   
                                                <div class="product_name" ><<?php echo 'a style="font-size: 18px" href="../controller/product_controller.php?action=index&product='.$proID.'"'; ?>><?php echo $proName;?></a></div>  
                                        ...
                                        <div class="ml-auto text-right">    
                                            ...
                                            <div class="product_price text-right" style="font-size: 16px"><?php echo $price;?></div>    
                                        </div>  
                                    </div>  
